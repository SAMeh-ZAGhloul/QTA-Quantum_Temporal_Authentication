...
<video width="640" height="480" controls>
  <source src="QTA-Quantum_Temporal_Authentication.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>

*Note: video genearted using NoteBookLLM - If the video plays without sound, ensure your browser's volume is not muted and check the player's volume controls.*
